...
#
SHORTDESC="Distance correlation matrix and graph for a given set of variables"

# Long description for package homepage on PyPI
#
DESC="""Pearson correlation only really detects linear relationships. Distance Correlation is a better measure, detecting more varied dependency relationships between variables.
...
#
ext_module_dostuff    = declare_cython_extension( "correlade.correlade",               use_math=False, use_openmp=False , include_dirs=my_include_dirs )
...
setup(
    ...
    #
    keywords = ["correlation data-science pandas"],
    ...
    package_data={'correlade': ['*.pxd', '*.pyx'],},
